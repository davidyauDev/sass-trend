...
final class CreateProfessionalGroupAction
{
     ...
     */
    public function handle(User $actor, array $data): ProfessionalGroup
    {
        $this->guard->ensureCanManage($actor);

        return DB::transaction(function () use ($data): ProfessionalGroup {
            $group = ProfessionalGroup::query()->create([
                'name' => $data['name'],
