...
$centralDomains = env('TENANCY_CENTRAL_DOMAINS');

if (! is_string($centralDomains) || $centralDomains === '') {
...
return [
     ...
     */
    'central_domains' => array_values(array_filter(array_map('trim', explode(',', $centralDomains)))),
